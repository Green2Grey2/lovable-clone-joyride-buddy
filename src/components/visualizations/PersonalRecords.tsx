      ...
      const calculatedRecords: PersonalRecord[] = [
        {
          id: '1',
          type: 'Longest Streak',
          value: stats.best_streak || stats.current_streak || 0,
          unit: 'days',
          date: new Date().toISOString(),
          previousValue: Math.max(0, (stats.best_streak || 0) - 5),
          improvement: 5,
          icon: Flame,
        ...
        },
        {
          id: '4',
          type: 'Most Calories',
          value: Math.max(...activities.map(a => a.calories || 0)),
          unit: 'cal',
          date: activities.find(a => a.calories === Math.max(...activities.map(a => a.calories || 0)))?.date || new Date().toISOString(),
          previousValue: 450,
          improvement: 12,
          icon: TrendingUp,
